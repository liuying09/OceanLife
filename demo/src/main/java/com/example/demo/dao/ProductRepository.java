...
public interface ProductRepository extends JpaRepository<ProductModel, Long> {
	...
	@Query(value = "INSERT INTO heroku_895d9448560c022.ocean_product(PRODUCTNAME, PRODUCTPRICE,PRODUCTPRICESALE,PRODUCTIMG,PRODUCTTYPE,PRODUCTNUM,PRODUCTCONTENT,PRODUCTSPENMATERIAL,PRODUCTSPENSIZE,PRODUCTSPENMF,PRODUCTREMARK,CREATE_DATE,UPDATE_DATE) "
